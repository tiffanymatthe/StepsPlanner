...
def main(_seed, _config, _run):
    ...
    for iteration in range(num_updates):
            ...
            for i in range(4):
                ...
                if (
                    ...
                    and (
                        ...
                        or (avg_curriculum_nanmean >= advance_threshold - 3 and (current_iteration >= 1000 or current_behavior_curriculum == 5))
                    )
                    ...
                    and (
                        ...
                        or (avg_timing_met_nanmean >= 1.7 and (current_iteration >= 1000))
                    )
        ...
        value_loss, action_loss, dist_entropy, critic_frac, actor_frac, critic_bias, actor_bias = agent.update(rollouts)
            ...
            logger.log_epoch(
                {
                    ...
                    "max_critic_bias_replaced": critic_bias,
                    "max_actor_bias_replaced": actor_bias,
