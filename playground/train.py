            ...
            logger.log_epoch(
                {
                    ...
                    "curriculum_metric_per_mask": wandb.Histogram(mean_metric),
                    "avg_heading_err_per_mask": wandb.Histogram(heading_metric),
                    "avg_timing_met_per_mask": wandb.Histogram(timing_metric),
