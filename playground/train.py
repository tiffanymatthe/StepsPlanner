            ...
            for i in range(4):
                ...
                if (
                    ...
                    and (
                        ...
                        avg_curriculum_nanmean > (advance_threshold if (current_curriculum > 0 or args.net is not None) else 10)
                    )
                    ...
                    and (np.isnan(avg_timing_met_nanmean) or avg_timing_met_nanmean >= 1.8)
                    and (np.isnan(avg_dist_err_nanmean) or avg_dist_err_nanmean <= 0.07)
                ):
                    continue
                else:
                    update_curriculum = False
