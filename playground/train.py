...
def main(_seed, _config, _run):
    ...
    distiller = Distiller(env_name, env_kwargs, args.seed, args.device, args.num_processes, 100, envs, dummy_env, args.experiment_dir)
            ...
            for i in range(4):
                ...
                if (
                    ...
                    and (
                        ...
                        or avg_heading_err_nanmean < (7 * DEG2RAD if (current_curriculum > 0 or args.net is not None) else 25 * DEG2RAD)
