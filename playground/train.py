        ...
        with torch.no_grad():
            ...
            for i in range(4):
                ...
                if (
                    ...
                    and (np.isnan(avg_timing_met_nanmean) or avg_timing_met_nanmean >= 1.75 or (avg_timing_met_nanmean >= 1.7 and (current_iteration >= 3000 or current_behavior_curriculum == 5)))
