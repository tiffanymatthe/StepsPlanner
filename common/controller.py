...
class Policy(nn.Module):
    ...
    def setup_feature_logging(self) -> None:
        ...
        # Prepare for logging
        self.activations = {}
        self.feature_keys = [self.critic[i] for i in [1,3,5,7]]
        self.layers_to_check = [self.critic[i] for i in [0,2,4,6,8]]
...
class SoftsignActor(nn.Module):
    ...
    def setup_feature_logging(self) -> None:
        ...
        # Prepare for logging
        self.activations = {}
        self.feature_keys = [self.net[i] for i in [7,9]]
        self.layers_to_check = [self.net[i] for i in [6,8,10]]
