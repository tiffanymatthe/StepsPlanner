...
class WalkerBase:
    ...
    def load_robot_model(self, model_path, flags, root_link_name=None):
        ...
        upper_root = "head" if "head" in self.parts else "waist"
        self.upper_arm_and_head_ids = [self.parts["right_upper_arm"].bodyPartIndex, self.parts["left_upper_arm"].bodyPartIndex, self.parts[upper_root].bodyPartIndex]
