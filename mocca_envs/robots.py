...
class Walker3DLongLegs(WalkerBase):
    ...
    def load_robot_model(self, model_path=None, flags=None, root_link_name=None):
        ...
        if model_path is None:
            model_path = os.path.join(current_dir, "data", "robots", "walker_3d_long_legs.xml")

        # Need to call this first to parse body
        super(Walker3DLongLegs, self).load_robot_model(model_path, flags, root_link_name)
...
class Walker3DFatLegs(WalkerBase):
    ...
    def load_robot_model(self, model_path=None, flags=None, root_link_name=None):
        ...
        if model_path is None:
            model_path = os.path.join(current_dir, "data", "robots", "walker3d_fat_legs.xml")

        # Need to call this first to parse body
        super(Walker3DFatLegs, self).load_robot_model(model_path, flags, root_link_name)
