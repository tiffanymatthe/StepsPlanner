...
class Walker3DStepperEnv(EnvBase):
    ...
    def reset(self):
        ...
        self.walk_forward = self.np_random.choice([True, False], p=[0.40, 0.60])
        self.robot_state = self.robot.reset(
            random_pose=self.robot_random_start,
    ...
    def calc_potential(self):
        ...
        self.linear_potential = -(self.distance_to_target + foot_distance_to_target * 0) / self.scene.dt
