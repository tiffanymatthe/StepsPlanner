...
class Walker3DStepperEnv(EnvBase):
    ...
    def generate_step_placements(self):
        ...
        max_horizontal_shift = sep_dist * 5
    ...
    def calc_potential(self):
        ...
        if self.next_step_index > 4:
            foot_distance_to_target = min(foot_distance_to_target, 0.3)
    ...
    def calc_base_reward(self, action):
        ...
        linear_progress = self.linear_potential - old_linear_potential
        self.progress = linear_progress * 1.3
        ...
        # if self.target_reached and abs(swing_foot_tilt) > 10 * DEG2RAD:
