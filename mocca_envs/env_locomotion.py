...
class Walker3DStepperEnv(EnvBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.behavior_timing_thresholds = [1.85, 1.75, 1.75, 1.75, 1.75, 1.75, 1.75, 1.75, 1.75, 1.75, 1.75]
    ...
    def generate_step_placements(self):
        ...
        if self.behaviors[self.behavior_curriculum] == "combine_all":
            self.selected_curriculum = self.np_random.choice(list(range(0,self.max_curriculum)))
