...
class Walker3DStepperEnv(EnvBase):
    ...
    def __init__(self, **kwargs):
        ...
        self.behaviors = ["heading_var", "timing_gaits", "to_standstill", "backward", "random_walks_backward", "turn_in_place", "side_step", "one_step_plant", "random_walks", "transition_all", "combine_all", "combine_all_heading"] # "transition_all"] # "turn_in_place", "side_step", "random_walks", "combine_all", "transition_all"]
        self.behavior_timing_thresholds = [1.8, 1.7, 1.7, 1.7, 1.7, 1.7, 1.7, 1.7, 1.7, 1.7, 1.7, 1.7]
        ...
        self.dist_range = {
            ...
            "random_walks": np.array([0.55, 0.65]),
    ...
    def get_timing(self, N):
        if self.selected_curriculum == 0 and self.selected_behavior == "one_step_plant":
            ...
            ground_ratio = self.np_random.choice([0.2,0.3,0.4,0.5], size=N)
            # else:
    ...
    def reset(self, force=False):
        ...
        if self.behaviors[self.behavior_curriculum] == "combine_all_heading":
    ...
    def step(self, action):
        ...
        all_rewards = {
            ...
            "step bonus": self.step_bonus,
            "target bonus": self.target_bonus,
            "tall": self.tall_bonus,
            "posture": -self.posture_penalty,
            "joints": -self.joints_penalty,
            "legs": self.legs_bonus,
            "elbow": -self.elbow_penalty * self.elbow_weight,
        ...
        # print(f"{self.next_step_index}: {all_rewards}")
    ...
    def calc_potential(self):
        ...
        multiplier = 0.5 # if (self.curriculum > 0 or self.behavior_curriculum > 0 or self.from_net) else 0.1
