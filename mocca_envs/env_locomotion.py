...
from mocca_envs.robots import Child3D, Laikago, Mike, Monkey3D, Walker2D, Walker3D, Walker3DLongLegs, Walker3DLongArms, Walker3DFatLegs
...
class Walker3DStepperEnv(EnvBase):
    ...
    robot_class = Walker3D #LongArms # Walker3DFatLegs #Walker3D
    robot_random_start = True
    ...
    def calc_base_reward(self, action):
        ...
        check_other_foot_on_ground = not self.mask_info["timing"][2] and self.current_step_time <= self.terrain_info[self.next_step_index, 10] #np.array([self.right_expected_contact, self.left_expected_contact])[1-self.swing_leg] == 1
