...
class Walker3DStepperEnv(EnvBase):
    ...
    def calc_base_reward(self, action):
        ...
        elif self.swing_leg_grounded_count > 1:
            # if self.swing_leg_grounded_count == 2:
        ...
        self.done = self.done or self.tall_bonus < 0 or abs_height < -3 or (self.target_reached and not self.in_target and self.target_reached_count == 1) or self.swing_leg_grounded_count > 300
    ...
    def calc_feet_state(self):
        ...
        if self.target_reached:
            ...
            if self.target_reached_count >= 1200:
