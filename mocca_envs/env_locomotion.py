...
class Walker3DStepperEnv(EnvBase):
    ...
    def calc_potential(self):
        ...
        if self.match_feet:
            ...
            self.linear_potential = -(body_distance_to_target + foot_distance_to_target * 0.7) / self.scene.dt
        ...
        self.linear_potential += - foot_angle_delta * 0.5 / self.scene.dt
    ...
    def delta_to_k_targets(self):
        ...
        if self.match_feet:
            if True: # (self.path_angle >= 0 and self.swing_leg == 0) or (self.path_angle <= 0 and self.swing_leg == 1) or not hasattr(self, 'walk_target'):
