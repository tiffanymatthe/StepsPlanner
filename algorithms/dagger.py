...
def train(
    expert_policy, # hopping
    student_policy, # rest of it
    envs_per_task,
    ...
    for epoch in range(num_epochs):
        ...
        for task_i in range(num_tasks):
            ...
            buffer_observations_per_task[task_i][num_steps * num_epochs].copy_(torch.from_numpy(obs))
            with torch.no_grad():
    ...
    torch.save(student_policy.state_dict(), student_file_name)
