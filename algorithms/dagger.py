...
def train(
    ...
    buffer_expert_values = torch.zeros(num_steps * num_epochs, num_processes, act_dim, device=device)
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            for step in range(num_steps):
                ...
                expert_value, expert_action, _ = expert_policy.act(
                ...
                buffer_expert_values[buffer_index].copy_(expert_value)
